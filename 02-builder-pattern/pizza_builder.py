...
STEP_DELAY = 3  # in seconds for the sake of the exampl
...
def validate_style(builders):
    try:
        ...
        err_msg = 'Sorry, only margarita (key m) and creamy (key c) are available'
        print(err_msg)
        return False, None
    return True, builder
...
def main():
    ...
    pizza = waiter.builder.pizza
    print()
    print(f'Enjoying your {pizza}')
